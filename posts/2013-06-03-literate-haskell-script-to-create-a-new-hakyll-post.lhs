...
<div class="page"><div>![Yo dawg I heard you like scripts and blogs so I put a script to make blogs
inside a blog about the script to make blogs so you can blog about scripts while
you script about blogs](/posts/2013/06/03/literate-haskell-script-to-create-a-new-hakyll-post/yodawg.jpg)</div></div>
